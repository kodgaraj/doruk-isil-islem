                        ...
                        <div class="card-body p-3">
                            <div class="ps-5 pe-5">
                                ...
                                <form class="form-horizontal"  action="{{ route('authenticate') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="email" class="form-control input-radius" id="email" placeholder="E-MAIL">
                                    </div>
                                    <div class="mb-3">
                                        <input type="password" class="form-control input-radius" id="sifre" placeholder="ŞİFRE">
                                    </div>
                                    <div class="mt-5">
