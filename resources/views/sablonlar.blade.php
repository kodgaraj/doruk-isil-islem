        ...
        let mixinApp = {
            ...
            data() {
                return {
                    ...
                    sablonTurleri: [{"adi":"","ogeler":[]},{"adi":"TEKLIF","ogeler":["[tarih]","[firmaAdi]","[sorumluKisi]","[telefon]","[adres]","[eposta]","[teklifIcerikleri]","[gecerlilikTarihi]"]}, {"adi":"ISLEM","ogeler":["[tarih]","[firmaAdi]","[sorumluKisi]","[gecerlilikTarihi]"]},{"adi":"MAIL","ogeler":["[firmaAdi]","[tur]","[eposta]"]}],
                    sablonlar: [],
                    sablonSayfaSayisi: 0,
                    yeniSablon: {
                        sablonAdi: "",
