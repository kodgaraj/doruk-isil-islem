                  ...
                  <template v-else>
                    ...
                    <template v-else>
                      <template v-for="(form, index) in formlar.data">
                        <tr :key="index + 'form'" @click="formIslemleriGetir(form.id, index)" style="cursor: pointer;">
                        ...
                        <tr v-if="_.size(form.islemler) && form.islemlerAcik" class="bg-primary py-0"
                          ...
                          <td colspan="100%" class="text-center p-0">
                            <div class="col-12 text-center"
                              ...
                              <div class="row">
                                <div v-for="(firin, fIndex) in form.islemler" :key="fIndex + 'firin'" class="col-12 p-0">
                                      ...
                                      <template v-for="(sarj, sIndex) in firin.sarjlar">
                                        <h6 class="card-subtitle my-2 text-muted" :key="sIndex + 'sarj'">
                                          ...
                                          <i v-if="sarj.islemDurumuKodu === 'TAMAMLANDI'"
                                            class="fas fa-check text-success"></i>
                                          <button v-if="sarj.bekleyenIslemSayisi > 0" class="btn btn-sm btn-success ms-1"
                                            @click="sarjIslemleriBaslat(firin, sarj.sarj, form.id, index)">
                                            <i class="fas fa-play me-1"></i>
                                            İŞLEMLERİ BAŞLAT
                                          </button>
                                          <button v-if="sarj.islemdekiIslemSayisi > 0" class="btn btn-sm btn-danger ms-1"
                                            @click="sarjIslemleriTamamla(firin, sarj.sarj, form.id, index)">
                                            <i class="fas fa-play me-1"></i>
                                            İŞLEMLERİ TAMAMLA
                                          </button>
                                        </h6>
                                        <div class="table-responsive overflow-hidden" :key="sIndex + 'islemler'">
                                            ...
                                            <tbody>
                                              <template v-for="(islem, iIndex) in sarj.islemler">
                                                <tr :key="iIndex + 'islemler'"
                                                    ...
                                                    <div class="row">
                                                      <div class="col-12 d-inline-flex">
                                                        ...
                                                        <div v-if="islem.tekrarEdilenId" class="ms-1">
                                                          <span class="badge rounded-pill bg-danger">Tekrar Edilen İşlem
                                                            ID: @{{ islem.tekrarEdilenId }}</span>
                                                        </div>
                                                      </div>
                                                      <div class="col-12">
                                                        <span class="badge badge-pill bg-primary">Sipariş No:
                                                          @{{ islem.siparisNo }}</span>
                                                      </div>
                                                      <div class="col-12" v-if="islem.islemDurumuKodu !== 'TAMAMLANDI'">
                                                        <span class="badge badge-pill"
                                                          :class="`bg-${ islem.gecenSureRenk }`">Termin:
                                                          @{{ islem.gecenSure }} Gün</span>
                                                      </div>
                                                      <div class="col-12">
                                                  ...
                                                  <td>
                                                    <div class="row">
                                                      ...
                                                      <div class="col-12">
                                                        <small class="text-muted">Miktar: @{{ islem.miktar }}
                                                          kg</small>
                                                      </div>
                                                      <div class="col-12">
                                                  ...
                                                  <td>
                                                    <div class="row">
                                                      ...
                                                      <div class="col-12">
                                                        <small class="text-muted">İ. Sertlik:
                                                  ...
                                                  <td class="uzun-uzunluk text-center align-center">
                                                    <div class="btn-group row">
                                                      <div class="col-12">
                                                        <b :class="islem.islemDurumRenk">
                                                          <i class="ml-2" :class="islem.islemDurumuIkon"></i>
                                                      ...
                                                      <div class="col-12">
                                                        @can('isil_islem_duzenleme')
                                                          ...
                                                          <button v-else-if="islem.islemDurumuKodu === 'ISLEMDE'"
                                                        ...
                                                        <template v-if="islem.islemDurumuKodu === 'TAMAMLANDI'">
                                                          ...
                                                          <div v-if="islem.tekrarEdenId" class="col-12">
                                                            <span class="badge rounded-pill bg-danger">Tekrar Eden İşlem
                                                              ID: @{{ islem.tekrarEdenId }}</span>
                                                          </div>
                                                        </template>
                                                        @can('isil_islem_duzenleme')
                                                          <button v-if="islem.islemDurumuKodu === 'ISLEMDE'"
                                                ...
                                                <template v-if="_.size(islem.tekrarEdenIslemler)">
                                                  <tr :key="'tekrarEdenler' + iIndex"
                                                    style="background-color: #F8747450; border: 1px solid #F87474;">
                                                    <td colspan="100%" class="p-0">
                                                      <div class="d-grid">
                                                        <button class="btn btn-sm btn-danger btn-block rounded-0 m-0 p-0"
                                                          type="button" data-bs-toggle="collapse"
                                                          :data-bs-target="'#collapseExample' + iIndex"
                                                          aria-expanded="false"
                                                          :aria-controls="'collapseExample' + iIndex">
                                                  ...
                                                  <template v-for="(tekrarEdenIslem, tiIndex) in islem.tekrarEdenIslemler">
                                                    <tr class="collapse" :id="'collapseExample' + iIndex"
                                                      style="background-color: #F8747425; border-right: 1px solid #F87474; border-left: 1px solid #F87474;"
                                                      :style="tiIndex === (_.size(islem.tekrarEdenIslemler) - 1) ?
                                                        ...
                                                        <div class="row">
                                                          <div class="col-12 d-inline-flex">
                                                            ...
                                                            <div v-if="tekrarEdenIslem.tekrarEdilenId" class="ms-1">
                                                              <span class="badge rounded-pill bg-danger">Tekrar Edilen
                                                                İşlem ID: @{{ tekrarEdenIslem.tekrarEdilenId }}</span>
                                                            </div>
                                                          </div>
                                                          <div class="col-12">
                                                            <span class="badge badge-pill bg-primary">Sipariş No:
                                                          ...
                                                          <div class="col-12">
                                                            <span class="badge badge-pill"
                                                              ...
                                                              @{{ tekrarEdenIslem.gecenSure }} Gün</span>
                                                          </div>
                                                          <div class="col-12">
                                                            <small class="text-muted">Firma:
                                                      ...
                                                      <td class="text-center">
                                                        <img
                                                          :src="tekrarEdenIslem.resimYolu ? tekrarEdenIslem.resimYolu :
                                                              varsayilanResimYolu"
                                                          class="kg-resim-sec"
                                                      ...
                                                      <td>
                                                        <div class="row">
                                                          ...
                                                          <div class="col-12">
                                                            <small class="text-muted">Adet: @{{ tekrarEdenIslem.adet }}
                                                              adet</small>
                                                          </div>
                                                          <div class="col-12">
                                                            <small class="text-muted">Miktar: @{{ tekrarEdenIslem.miktar }}
                                                              kg</small>
                                                          </div>
                                                          <div class="col-12">
                                                            <small class="text-muted">Dara: @{{ tekrarEdenIslem.dara }}
                                                              kg</small>
                                                          </div>
                                                        </div>
                                                      </td>
                                                        ...
                                                        <div class="btn-group row">
                                                          <div class="col-12">
                                                            <b :class="tekrarEdenIslem.islemDurumuRenk">
                                                              <i class="ml-2"
                                                                :class="tekrarEdenIslem.islemDurumuIkon"></i>
                                                            ...
                                                            <template
                                                              ...
                                                              <div v-if="tekrarEdenIslem.tekrarEdenId" class="col-12">
                                                                <span class="badge rounded-pill bg-danger">Tekrar Eden
                                                                  İşlem ID: @{{ tekrarEdenIslem.tekrarEdenId }}</span>
                                                              </div>
                                                            </template>
                                                            @can('isil_islem_duzenleme')
                                                              <button v-if="tekrarEdenIslem.islemDurumuKodu === 'ISLEMDE'"
                                                                class="btn btn-warning btn-sm"
                                                    ...
                                                    <tr v-if="tiIndex === (_.size(islem.tekrarEdenIslemler) - 1)"
                                                      class="collapse" :id="'collapseExample' + iIndex"
              ...
              <div class="row d-flex align-items-center justify-content-between">
                ...
                <div class="col">
                  <ul class="pagination pagination-rounded justify-content-center mb-0">
                    ...
                    <li v-for="sayfa in sayfalamaAyarla(formlar.last_page, formlar.current_page)" class="page-item"
