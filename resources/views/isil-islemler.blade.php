            ...
            <div class="card-body">
                <template v-if="aktifSayfa.kod === 'ANASAYFA'">
                    <div class="row">
                        <div class="col">
                            <h4 class="card-title">
                                <a @click="returnBack()" class="btn btn-warning"><i class="fas fa-arrow-left"></i>
                                    GERİ</a>
                                FORMLAR
                            </h4>
                        </div>
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-auto ps-0">
                                    ...
                                    <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                        data-bs-target="#filtrelemeModal">
                                ...
                                <div class="col-auto">
                                    @can('isil_islem_formu_kaydetme')
                                        <button @click="formEkleAc" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>
                                            FORM EKLE</button>
                                    @endcan
                                </div>
                            </div>
                            <div class="modal fade" id="filtrelemeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true">
                                            ...
                                            <div class="row gap-3">
                                                <div class="col-12 m-0">
                                                    <div class="form-group">
                                                        <div class="row d-flex align-items-center justify-space-between">
                                                            ...
                                                            <div class="col-auto">
                                                                <button
                                                                    ...
                                                                    type="button" aria-label="Tarih temizle">
                                                                    <span class="px-1">
                                                                        Tarihleri Temizle
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="filtrelemeObjesi.baslangicTarihi" type="date"
                                                                class="form-control" placeholder="Başlangıç"
                                                            ...
                                                            <input v-model="filtrelemeObjesi.bitisTarihi" type="date"
                                                                class="form-control" placeholder="Bitiş"
                                                                data-date-container='#datepicker2' data-provide="datepicker"
                                                                data-date-autoclose="true" id="tarih"
                                                                aria-label="Bitiş" />
                                                        </div>
                                                ...
                                                <div class="col-auto m-0">
                                                    <div class="form-group">
                                                        ...
                                                        <v-select v-model="sayfalamaSayisi" :options="sayfalamaSayilari"
                                                            id="sayfalamaSayisi"></v-select>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <tr :key="index + 'form'"
                                                            ...
                                                            <td class="kisa-uzunluk">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <span># @{{ form.id }}</span>
                                                                        <i v-if="form.bitisTarihi"
                                                                            class="fas fa-check text-success"></i>
                                                                        <div class="d-inline-flex"
                                                                            v-if="form.islemYukleniyor">
                                                                            <div class="spinner-grow text-primary m-1 spinner-grow-sm"
                                                                                role="status">
                                                                                <span class="sr-only">Yükleniyor...</span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-12">
                                                                        <span
                                                                            class="badge badge-pill bg-primary">@{{ form.takipNo }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="uzun-uzunluk">@{{ form.formAdi }}</td>
                                                            <td class="text-center kisa-uzunluk">@{{ form.islemSayisi }}
                                                            </td>
                                                            <td class="kisa-uzunluk">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                            ...
                                                            <td class="text-center orta-uzunluk">
                                                                <div class="row g-1 d-inline-flex">
                                                                    <div class="col">
                                                                        <button @click.stop="formDetayGoruntule(form)"
                                                                    ...
                                                                    @can('isil_islem_formu_duzenleme')
                                                                        <div class="col">
                                                                            <button @click.stop="formDuzenle(form)"
                                                                    ...
                                                                    @can('isil_islem_formu_silme')
                                                                        <div class="col">
                                                                            <button @click.stop="formSil(form)"
                                                                    ...
                                                                    @endcan
                                                                    <div class="col-12">
                                                                        <span class="badge badge-pill bg-success">Son
                                                                            Düzenleyen: @{{ form.duzenleyen }}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr v-if="_.size(form.islemler) && form.islemlerAcik"
                                                            class="bg-primary py-0" :key="index + 'formIslemleri'">
                                                            <td colspan="100%" class="text-center p-0">
                                                                <div class="col-12 text-center"
                                                                    style="overflow-y: auto; overflow-x: hidden; max-height: 400px; border: 1px solid blue;">
                                                                    <div class="row">
                                                                        <div v-for="(firin, fIndex) in form.islemler"
                                                                            :key="fIndex + 'firin'" class="col-12 p-0"
                                                                            ...
                                                                            <div class="card text-start my-1"
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <h5 class="card-title">
                                                                                        @{{ firin.firinAdi }}
                                                                                        <i v-if="firin.islemDurumuKodu === 'TAMAMLANDI'"
                                                                                            class="fas fa-check text-success"></i>
                                                                                    </h5>
                                                                                    <template
                                                                                        v-for="(sarj, sIndex) in firin.sarjlar">
                                                                                        <h6 class="card-subtitle my-2 text-muted"
                                                                                            :key="sIndex + 'sarj'"
                                                                                            :ref="'firin' + firin.firinId +
                                                                                                'sarj' + sarj.sarj">
                                                                                            @{{ sarj.sarj }}. Şarj
                                                                                            <i v-if="sarj.islemDurumuKodu === 'TAMAMLANDI'"
                                                                                                class="fas fa-check text-success"></i>
                                                                                            <button
                                                                                        ...
                                                                                        <div class="table-responsive overflow-hidden"
                                                                                            ...
                                                                                            <table id="tech-companies-1"
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <template
                                                                                                        v-for="(islem, iIndex) in sarj.islemler">
                                                                                                        <tr :key="iIndex +
                                                                                                            'islemler'"
                                                                                                            :class="{
                                                                                                                'table-danger':
                                                                                                                    ...
                                                                                                                    .tekrarEdenId,
                                                                                                                'table-primary': islem
                                                                                                                    .islemDurumuKodu === 'ISLEM_BEKLIYOR',
                                                                                                                'table-warning': islem
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <span>
                                                                                                                            #
                                                                                                                            @{{ islem.id }}
                                                                                                                            <i v-if="islem.islemDurumuKodu === 'TAMAMLANDI'"
                                                                                                                                class="fas fa-check text-success"></i>
                                                                                                                        </span>
                                                                                                                        <div v-if="islem.tekrarEdilenId"
                                                                                                                            class="ms-1">
                                                                                                                            <span
                                                                                                                                class="badge rounded-pill bg-danger">Tekrar
                                                                                                                                Edilen
                                                                                                                                İşlem
                                                                                                                                ID:
                                                                                                                                @{{ islem.tekrarEdilenId }}</span>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <div
                                                                                                                        class="col-12">
                                                                                                                        <span
                                                                                                                            class="badge badge-pill bg-primary">Sipariş
                                                                                                                            No:
                                                                                                                            @{{ islem.siparisNo }}</span>
                                                                                                                    </div>
                                                                                                                    <div class="col-12"
                                                                                                                        v-if="islem.islemDurumuKodu !== 'TAMAMLANDI'">
                                                                                                                        <span
                                                                                                                            class="badge badge-pill"
                                                                                                                            :class="`bg-${ islem.gecenSureRenk }`">Termin:
                                                                                                                            @{{ islem.gecenSure }}
                                                                                                                            Gün</span>
                                                                                                                    </div>
                                                                                                                    <div
                                                                                                                        class="col-12">
                                                                                                                        <small
                                                                                                                            class="text-muted">Firma:
                                                                                                                            @{{ islem.firmaAdi }}</small>
                                                                                                                    </div>
                                                                                                                    <div v-if="islem.bolunmusId"
                                                                                                                        class="col-12">
                                                                                                                        <span
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="col-12">
                                                                                                                        <small
                                                                                                                            class="text-muted">Türü:
                                                                                                                            @{{ islem.islemTuruAdi ? islem.islemTuruAdi : "-" }}</small>
                                                                                                                    </div>
                                                                                                                    <div
                                                                                                                        class="col-12">
                                                                                                                        <small
                                                                                                                            class="text-muted">İ.
                                                                                                                            Sertlik:
                                                                                                                            @{{ islem.istenilenSertlik ? islem.istenilenSertlik : "-" }}</small>
                                                                                                                    </div>
                                                                                                                    <div
                                                                                                                        class="col-12">
                                                                                                                        <small
                                                                                                                            class="text-muted">Kalite:
                                                                                                                            @{{ islem.kalite ? islem.kalite : "-" }}</small>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </td>
                                                                                                            <td
                                                                                                                class="uzun-uzunluk text-center align-center">
                                                                                                                <div
                                                                                                                    class="btn-group row">
                                                                                                                    <div
                                                                                                                        class="col-12">
                                                                                                        ...
                                                                                                        <template
                                                                                                            v-if="_.size(islem.tekrarEdenIslemler)">
                                                                                                            <tr :key="'tekrarEdenler' +
                                                                                                            iIndex"
                                                                                                                style="background-color: #F8747450; border: 1px solid #F87474;">
                                                                                                                <td colspan="100%"
                                                                                                                    class="p-0">
                                                                                                                    <div
                                                                                                                        class="d-grid">
                                                                                                                        <button
                                                                                                                            class="btn btn-sm btn-danger btn-block rounded-0 m-0 p-0"
                                                                                                                            type="button"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                class="col-12 d-inline-flex">
                                                                                                                                <span>#
                                                                                                                                    @{{ tekrarEdenIslem.id }}</span>
                                                                                                                                <div v-if="tekrarEdenIslem.tekrarEdilenId"
                                                                                                                                    class="ms-1">
                                                                                                                                    <span
                                                                                                                                        class="badge rounded-pill bg-danger">Tekrar
                                                                                                                                        Edilen
                                                                                                                                        İşlem
                                                                                                                                        ID:
                                                                                                                                        @{{ tekrarEdenIslem.tekrarEdilenId }}</span>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                            <div
                                                                                                                                class="col-12">
                                                                                                                                <span
                                                                                                                                    class="badge badge-pill bg-primary">Sipariş
                                                                                                                                    No:
                                                                                                                                    @{{ tekrarEdenIslem.siparisNo }}</span>
                                                                                                                            </div>
                                                                                                                            <div
                                                                                                                                class="col-12">
                                                                                                                                <span
                                                                                                                                    class="badge badge-pill"
                                                                                                                                    :class="`bg-${ tekrarEdenIslem.gecenSureRenk }`">Termin:
                                                                                                                                    @{{ tekrarEdenIslem.gecenSure }}
                                                                                                                                    Gün</span>
                                                                                                                            </div>
                                                                                                                            <div
                                                                                                                                class="col-12">
                                                                                                                                <small
                                                                                                                                    class="text-muted">Firma:
                                                                                                                                    @{{ tekrarEdenIslem.firmaAdi }}</small>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                    <td
                                                                                                                        class="text-center">
                                                                                                                        <img :src="tekrarEdenIslem.resimYolu ? tekrarEdenIslem.resimYolu : varsayilanResimYolu"
                                                                                                                            class="kg-resim-sec"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <small
                                                                                                                                    class="text-muted">Türü:
                                                                                                                                    @{{ tekrarEdenIslem.islemTuruAdi ? tekrarEdenIslem.islemTuruAdi : "-" }}</small>
                                                                                                                            </div>
                                                                                                                            <div
                                                                                                                                class="col-12">
                                                                                                                                <small
                                                                                                                                    class="text-muted">İ.
                                                                                                                                    Sertlik:
                                                                                                                                    @{{ tekrarEdenIslem.istenilenSertlik ? tekrarEdenIslem.istenilenSertlik : "-" }}</small>
                                                                                                                            </div>
                                                                                                                            <div
                                                                                                                                class="col-12">
                                                                                                                                <small
                                                                                                                                    class="text-muted">Kalite:
                                                                                                                                    @{{ tekrarEdenIslem.kalite ? tekrarEdenIslem.kalite : "-" }}</small>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                    <td
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                @endcan
                                                                                                                                <template
                                                                                                                                    v-if="tekrarEdenIslem.islemDurumuKodu === 'TAMAMLANDI'">
                                                                                                                                    @can('isil_islem_duzenleme')
                                                                                                                                        <button
                                                                                                                                            class="btn btn-danger btn-sm"
                                                                                                                                    ...
                                                                                                                                    @endcan
                                                                                                                                    <div v-if="tekrarEdenIslem.tekrarEdenId"
                                                                                                                                        class="col-12">
                                                                                                                                        <span
                                                                                                                                            class="badge rounded-pill bg-danger">Tekrar
                                                                                                                                            Eden
                                                                                                                                            İşlem
                                                                                                                                            ID:
                                                                                                                                            @{{ tekrarEdenIslem.tekrarEdenId }}</span>
                                                                                                                                    </div>
                                                                                                                                </template>
                                                                                                                                @can('isil_islem_duzenleme')
                                                                                                                                    <button
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <span
                                                                                                                                    class="badge badge-pill"
                                                                                                                                    :class="`bg-${ tekrarEdenIslem.firinRenk }`">@{{ tekrarEdenIslem.firinAdi }}</span>
                                                                                                                            </div>
                                                                                                                            <div
                                                                                                                                class="col-12">
                                                                                                                                <span
                                                                                                                                    class="badge badge-pill bg-secondary">@{{ tekrarEdenIslem.sarj }}.
                                                                                                                                    ŞARJ</span>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr v-if="tiIndex === (_.size(islem.tekrarEdenIslemler) - 1)"
                                                                                                                    class="collapse"
                                                                                                                    :id="'collapseExample' +
                                                                                                                    iIndex"
                                                                                                                    :key="'d' +
                                        ...
                                        <div class="row d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col">
                                                <ul class="pagination pagination-rounded justify-content-center mb-0">
                                                    <li class="page-item">
                                                        <button class="page-link" :disabled="!formlar.prev_page_url"
                                                            @click="formlariGetir(formlar.prev_page_url)">
                                                            <i class="fas fa-angle-left"></i>
                                                        </button>
                                                    </li>
                                                    <li v-for="sayfa in sayfalamaAyarla(formlar.last_page, formlar.current_page)"
                                                        class="page-item" :class="[sayfa.aktif ? 'active' : '']">
                                                        <button class="page-link"
                                                            @click="sayfa.tur === 'SAYFA' ? formlariGetir('/formlar?page=' + sayfa.sayfa) : ()  => {}">@{{ sayfa.sayfa }}</button>
                                                    </li>
                                                    <li class="page-item">
                                                        <button class="page-link" :disabled="!formlar.next_page_url"
                                                            @click="formlariGetir(formlar.next_page_url)">
                ...
                <template v-else-if="aktifSayfa.kod === 'YENI_FORM'">
                    <div class="row">
                        <div class="col-12 col-sm-8">
                            <div class="d-flex flex-row align-items-center">
                                <button @click="geriAnasayfa" class="btn btn-warning"><i class="fas fa-arrow-left"></i>
                                    GERİ</button>
                                <h4 class="card-title m-0 ms-2 text-nowrap text-truncate">
                                    ISIL İŞLEM FORMU EKLEME
                                    <div class="col-12" v-if="aktifForm.duzenleyen">
                                        <span class="badge badge-pill bg-success">Son Düzenleyen:
                                            @{{ aktifForm.duzenleyen }}</span>
                                    </div>
                        ...
                        <div class="col-12 col-sm-4 text-end">
                            <button @click="formHazirla()" class="btn btn-primary"
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-sm-6 col-md-4 mb-2">
                            ...
                            <input v-model="aktifForm.takipNo" v-mask="'TKP##########'" class="form-control"
                                placeholder="Form numarası giriniz... (Örn: TKP2022060301)" type="text" />
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 mb-2">
                            <label class="form-label">Form Adı *</label>
                            <input v-model="aktifForm.formAdi" class="form-control" placeholder="Form adı giriniz..."
                                type="text" />
                        ...
                        <div class="col-12 col-sm-6 col-md-4 mb-2">
                            <div class="form-group">
                                ...
                                <input v-model="aktifForm.baslangicTarihi" type="date" class="form-control"
                                    placeholder="gg.aa.yyyy" data-date-container='#datepicker2' data-provide="datepicker"
                                    data-date-autoclose="true" id="baslangicTarihi" />
                                <small class="text-muted">Bitiş tarihi, formdaki tüm işlemler bittiğinde otomatik olarak
                                    ayarlanır</small>
                            </div>
                        </div>
                        <div class="col-12">
                            <label for="baslangicTarihi">Açıklama</label>
                            <textarea v-model="aktifForm.aciklama" class="form-control" id="aciklama" name="aciklama" rows="3"></textarea>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="row d-flex align-items-center">
                                                <div class="col">
                                                    <div class="input-group">
                                                        <input v-model="filtrelemeObjesi.firmaArama" type="text"
                                                            class="form-control" placeholder="Arama" aria-label="Arama"
                                                            aria-describedby="arama"
                                                            @keyup.enter="firmaGrupluIslemleriGetir()"
                                                            @input="gecikmeliFonksiyon.firmaGrupluIslemleriGetir()" />
                                                        <span @click="firmaGrupluIslemleriGetir()"
                                                            class="input-group-text waves-effect" id="arama">
                                                            <i class="mdi mdi-magnify"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-auto m-0">
                                            <div class="row d-flex align-items-center">
                                                <div class="col">
                                                    <div class="input-group">
                                                        <v-select v-model="islemSayfalamaSayisi"
                                                            :options="sayfalamaSayilari" id="islemSayfalamaSayisi"
                                                            @input="firmaGrupluIslemleriGetir()"></v-select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                            ...
                            <template v-else>
                                <div class="col-12 mt-2">
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                                            <table id="tech-companies-1"
                                                class="table table-striped table-hover table-centered">
                                                <thead>
                                                    <tr>
                                                        <th>İşlem ID</th>
                                                ...
                                                <tbody>
                                                    <tr v-for="(islem, iIndex) in aktifForm.firmaGrupluIslemler.data"
                                                        :key="iIndex">
                                                        <td class="kisa-uzunluk">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                ...
                                                                <div class="col-12">
                                                                    <span class="badge bg-primary">Sipariş No:
                                                                        @{{ islem.siparisNo }}</span>
                                                                </div>
                                                                <div v-if="islem.tekrarEdenId" class="col-12">
                                                                    <span class="badge rounded-pill bg-danger">Tekrar Eden
                                                                        İşlem ID: @{{ islem.tekrarEdenId }}</span>
                                                                </div>
                                                                <div v-if="islem.tekrarEdilenId" class="col-12">
                                                                    <span class="badge rounded-pill bg-info">Tekrar Edilen
                                                                        İşlem ID: @{{ islem.tekrarEdilenId }}</span>
                                                                </div>
                                                        ...
                                                        <td class="kisa-uzunluk text-center">
                                                            <span class="badge badge-pill"
                                                                :class="`bg-${ islem.gecenSureRenk }`">@{{ islem.gecenSure }}
                                                                Gün</span>
                                                        </td>
                                                        <td class="text-center">
                                                            <img :src="islem.resimYolu ? islem.resimYolu : varsayilanResimYolu"
                                                                class="kg-resim-sec"
                                                                @click.stop="resimOnizlemeAc(islem.resimYolu)" />
                                                        </td>
                                                        <td class="uzun-uzunluk">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <small class="text-muted">Adet: @{{ islem.adet }}
                                                                        adet</small>
                                                                </div>
                                                                <div class="col-12">
                                                                    <small class="text-muted">Miktar:
                                                                        @{{ islem.miktar }} kg</small>
                                                                </div>
                                                                <div class="col-12">
                                                                    <small class="text-muted">Dara: @{{ islem.dara }}
                                                                        kg</small>
                                                                </div>
                                                                <div class="col-12">
                                                                    <small class="text-muted"><b>Net:
                                                                            @{{ islem.net }} kg</b></small>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="orta-uzunluk text-center">
                                                            <div class="form-group">
                                                                <select class="form-control select2" v-model="islem.firin"
                                                                    @change="formaEkle(islem)">
                                                                    <optgroup label="Fırınlar">
                                                                        <option v-for="(firin, firinIndex) in firinlar"
                                                                            :value="firin" :key="firinIndex">
                                                                            @{{ firin.ad }}
                                                                        </option>
                                                                    </optgroup>
                                                                </select>
                                                        ...
                                                        <td class="kisa-uzunluk text-center">
                                                            <div class="form-group">
                                                                <input v-model="islem.sarj" type="number"
                                                                    class="form-control" placeholder="Şarj (Örn: 1)"
                                                                    @change="formaEkle(islem)" />
                                                            </div>
                                                        </td>
                                                        <td class="orta-uzunluk text-center">
                                                            <button @click="formaIslemEkleSil(islem)" class="btn"
                                                                :class="islem.secildi == true ? 'btn-success' :
                                                                    'btn-outline-primary'">
                                                                <i class="fas"
                                                                    :class="islem.secildi == true ? 'fa-check' : 'fa-plus'"></i>
                                                            </button>
                                                            <button @click="islemBolAc(iIndex)"
                                                                class="btn btn-outline-warning p-1">
                                                                <i class="mdi mdi-call-split font-size-20 mx-1"></i>
                                                            </button>

                                                            <!-- Modal -->
                                                            <div class="modal fade" id="islemBolModal" tabindex="-1"
                                                                aria-labelledby="islemBolModal" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content"
                                                                        v-if="aktifBolunecekIslem.islem">
                                                                        <div class="modal-header">
                                                                            <div class="row text-start">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    <small
                                                                                        class="text-muted">@{{ aktifBolunecekIslem.islem.malzemeAdi }}
                                                                                        (Net: @{{ aktifBolunecekIslem.islem.net }}
                                                                                        kg)</small>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="modal-body text-start">
                                                                            <div class="row">
                                                                                <div class="col-12 mb-2"
                                                                                    v-for="(bIslem, bIndex) in aktifBolunecekIslem.bolunmusIslemler">
                                                                                    <div class="row align-items-end">
                                                                                        <div class="col-auto">
                                                                                            <div class="form-check">
                                                                                                <input
                                                                                                    v-model="bIslem.sabit"
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <div class="form-group">
                                                                                                <label
                                                                                                    for="">@{{ bIndex + 1 }}.
                                                                                                    Net KG
                                                                                                    (%@{{ _.round(bIslem.yuzde, 2) }})</label>
                                                                                                <input v-model="bIslem.net"
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <template
                                                                                v-if="_.size(aktifBolunecekIslem.hatalar)">
                                                                                <div class="col-12 text-start"
                                                                                    v-for="(hata, hKey, hIndex) in aktifBolunecekIslem.hatalar"
                                                                                    :key="hIndex">
                                                                                    <small class="text-danger">
                                                                                        <i
                                                                                            class="mdi mdi-info-outline text-danger"></i>
                                                                                        @{{ hIndex + 1 }})
                                                                                        @{{ hata }}
                                                                                    </small>
                                                                                </div>
                                                                            ...
                                                                            <div class="form-check">
                                                                                <input
                                                                                    v-model="aktifBolunecekIslem.kaydettiktenSonraSec"
                                                                                    class="form-check-input"
                                                                                    type="checkbox"
                                                                                    id="kaydettiktenSonraSec">
                                                                                <label class="form-check-label"
                                                                                    for="kaydettiktenSonraSec">
                                                                                    <small>
                                                                            ...
                                                                            <button type="button" class="btn btn-primary"
                                                                                :disabled="_.size(aktifBolunecekIslem.hatalar) !==
                                                                                    0 || yukleniyorObjesi.islemBol"
                                    ...
                                    <div class="row d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col">
                                            <ul class="pagination pagination-rounded justify-content-center mb-0">
                                                <li class="page-item">
                                                    <button class="page-link"
                                                        :disabled="!aktifForm.firmaGrupluIslemler.prev_page_url"
                                                        @click="firmaGrupluIslemleriGetir(null, aktifForm.firmaGrupluIslemler.prev_page_url)">
                                                        <i class="fas fa-angle-left"></i>
                                                    </button>
                                                </li>
                                                <li v-for="sayfa in sayfalamaAyarla(aktifForm.firmaGrupluIslemler.last_page, aktifForm.firmaGrupluIslemler.current_page)"
                                                    class="page-item" :class="[sayfa.aktif ? 'active' : '']">
                                                    <button class="page-link"
                                                        @click="sayfa.tur === 'SAYFA' ? firmaGrupluIslemleriGetir(null, `{{ route('firmaGrupluIslemleriGetir') }}?page=` + sayfa.sayfa) : ()  => {}">@{{ sayfa.sayfa }}</button>
                                                </li>
                                                <li class="page-item">
                                                    <button class="page-link"
                                                        :disabled="!aktifForm.firmaGrupluIslemler.next_page_url"
                                                        @click="firmaGrupluIslemleriGetir(null, aktifForm.firmaGrupluIslemler.next_page_url)">
                                                        <i class="fas fa-angle-right"></i>
                                                    </button>
                                                </li>
                                            </ul>
                ...
                <template v-else-if="aktifSayfa.kod === 'FORM_GORUNUMU'">
                    <div class="row">
                        <div class="col-12 col-sm-8">
                            <div class="d-flex flex-row align-items-center">
                                <button @click="geriYeniForm" class="btn btn-warning"><i class="fas fa-arrow-left"></i>
                                    GERİ</button>
                                <h4 class="card-title m-0 ms-2 text-nowrap text-truncate">
                                    @{{ aktifForm.formAdi }}
                                    <div class="col-12" v-if="aktifForm.duzenleyen">
                        ...
                        <div class="col-12 col-sm-4 text-end">
                            ...
                            @canany(['isil_islem_formu_duzenleme', 'isil_islem_formu_kaydetme'])
                                <button @click="formKaydet" class="btn btn-success" {{-- v-if="!aktifForm.detayGoruntule" --}}>
                                ...
                                <div class="table-responsive mb-0" data-pattern="priority-columns">
                                    <table id="formGorunumu" ref="formGorunumu" class="table">
                                        <thead>
                                            <tr>
                                                <th COLSPAN="100%"
                                                    style="color: black;border: 2px solid black; padding: 4px; text-align:center">
                                                    @{{ aktifForm.formAdi }}
                                                </th>
                                            </tr>
                                            <tr style="color: black;">
                                                <th style="border: 2px solid black">Fırın</th>
                                                <th style="border-bottom: 2px solid black; border-right: 2px solid black">
                                                    Şarj</th>
                                                <th style="border-bottom: 2px solid black; border-right: 2px solid black"
                                                    class="text-center">Resim</th>
                                                <th style="border-bottom: 2px solid black; border-right: 2px solid black">
                                                    Firma</th>
                                                <th style="border-bottom: 2px solid black; border-right: 2px solid black">
                                                    Malzeme</th>
                                        ...
                                        <tbody>
                                            <template
                                                v-for="(firin, firinId, firinIndex) in aktifForm.firinSarjGrupluIslemler">
                                                <template v-for="(sarj, sarjId, sarjIndex) in firin.sarjlar">
                                                    <template v-for="(islem, islemIndex) in sarj.islemler">
                                                        <tr :key="firinId + '-' + sarjId + '-' + islemIndex"
                                                            ...
                                                            <td v-if="sarjIndex === 0 && islemIndex === 0"
                                                                :style="sarjIndex === 0 && islemIndex === 0 ?
                                                                    'border-right: 2px solid black; border-bottom: 2px solid red;' :
                                                                    ''"
                                                                :rowspan="firin.toplamIslemSayisi"
                                                                style="border-right: 2px solid black;" class="dikey">
                                                                <span>@{{ firin.firinAdi }}</span>
                                                            </td>
                                                            <td v-if="islemIndex === 0"
                                                                :style="islemIndex === 0 && sarjIndex === (_.size(firin
                                                                        .sarjlar) - 1) ?
                                                                    'border-bottom: 2px solid red;' :
                                                                    'border-bottom: 2px solid black;'"
                                                                :rowspan="sarj.toplamIslemSayisi"
                                                                style="border-right: 2px solid black; padding: 4px;"
                                                                class="dikey">
                                                                <span>@{{ sarj.sarj }}. Şarj</span>
                                                            </td>
                                                            <td style="border-right: 2px solid black padding: 4px;"
                                                                :style="islemIndex === (_.size(sarj.islemler) - 1) &&
                                                                    sarjIndex === (_.size(firin.sarjlar) - 1) ?
                                                                    'border-bottom: 2px solid black; border-bottom: 2px solid red;' :
                                                                    'border-bottom: 2px solid black !important'"
                                                                class="kisa-uzunluk text-center">
                                                                <img :src="islem.resimYolu ? islem.resimYolu : varsayilanResimYolu"
                                                                    class="kg-resim-sec"
                                                                    @click.stop="resimOnizlemeAc(islem.resimYolu)" />
                                                            </td>
                                                            <td style="border-right: 2px solid black; padding: 4px;"
                                                                :style="islemIndex === (_.size(sarj.islemler) - 1) &&
                                                                    ...
                                                                    'border-bottom: 2px solid black; border-bottom: 2px solid red;' :
                                                                    'border-bottom: 2px solid black !important'"
                                                                class="orta-uzunluk align-left">@{{ truncateText(islem.firmaAdi, 50) }}
                                                            </td>
                                                            <td style="border-right: 2px solid black; padding: 4px;"
                                                                :style="islemIndex === (_.size(sarj.islemler) - 1) &&
                                                                    sarjIndex === (_.size(firin.sarjlar) - 1) ?
                                                                    'border-bottom: 2px solid black; border-bottom: 2px solid red;' :
                                                                    'border-bottom: 2px solid black !important'"
                                                                class="kisa-uzunluk align-left">@{{ islem.malzemeAdi }}
                                                            </td>
                                                            <td style="border-right: 2px solid black; padding: 4px;"
                                                                :style="islemIndex === (_.size(sarj.islemler) - 1) &&
                                                                    sarjIndex === (_.size(firin.sarjlar) - 1) ?
                                                                    'border-bottom: 2px solid black; border-bottom: 2px solid red;' :
                                                                    'border-bottom: 2px solid black !important'"
                                                                class="kisa-uzunluk align-left">@{{ islem.islemTuruAdi }}
                                                            </td>
                                                            <td style="border-right: 2px solid black; padding: 4px;"
                                                                :style="islemIndex === (_.size(sarj.islemler) - 1) &&
                                                                    sarjIndex === (_.size(firin.sarjlar) - 1) ?
                                                                ...
                                                                <template v-else>
                                                                    <input v-model="islem.istenilenSertlik" type="text"
                                                                        class="form-control"
                                                                        placeholder="İstenilen Sertlik" />
                                                                </template>
                                                            </td>
                                                            <td style="border-right: 2px solid black; padding: 4px;max-width: 25px !important;"
                                                                :style="islemIndex === (_.size(sarj.islemler) - 1) &&
                                                                    sarjIndex === (_.size(firin.sarjlar) - 1) ?
                                                                    'border-bottom: 2px solid black; border-bottom: 2px solid red;' :
                                                                    'border-bottom: 2px solid black !important'"
                                                                ...
                                                                <template v-else>
                                                                    <input v-model="islem.kalite" type="text"
                                                                        class="form-control" placeholder="Kalite" />
                                                                </template>
                                                            </td>
                                                            <td :style="islemIndex === 0 && sarjIndex === (_.size(firin.sarjlar) -
                                                                    1) ? 'border-bottom: 2px solid red;' :
                                                                'border-bottom: 2px solid black;'"
                                                                :rowspan="sarj.toplamIslemSayisi"
                                                                style="border-right: 2px solid black; padding: 4px;max-width: 25px !important;"
                                                                v-if="islemIndex === 0" class="en-kisa-uzunluk">
                                                                <template v-if="aktifForm.onizlemeModu">
                                                                    <span>@{{ islem.sicaklik }}</span>
                                                                </template>
                                                                <template v-else>
                                                                    <input v-model="islem.sicaklik" type="text"
                                                                        class="form-control" placeholder="Sıcaklık" />
                                                                </template>
                                                            </td>
                                                            <td :style="islemIndex === 0 && sarjIndex === (_.size(firin.sarjlar) -
                                                                    1) ? 'border-bottom: 2px solid red;' :
                                                                ...
                                                                <template v-else>
                                                                    <input v-model="islem.carbon" type="text"
                                                                        class="form-control" placeholder="Carbon" />
                                                                </template>
                                                            </td>
                                                            <td :style="islemIndex === 0 && sarjIndex === (_.size(firin.sarjlar) -
                                                                    1) ? 'border-bottom: 2px solid red;' :
                                                                ...
                                                                <template v-else>
                                                                    <input v-model="islem.beklenenSure" type="text"
                                                                        class="form-control" placeholder="Süre" />
                                                                </template>
                                                            </td>
                                                            <td style="border-right: 2px solid black; padding: 4px;max-width: 25px !important;"
                                                                :style="islemIndex === (_.size(sarj.islemler) - 1) &&
                                                                ...
                                                                <template v-else>
                                                                    <input v-model="islem.cikisSertligi" type="text"
                                                                        class="form-control" placeholder="Ç. Sertliği" />
                                                                </template>
                                                            </td>
                                                            <td style="border-right: 2px solid black; padding: 4px;max-width: 25px !important;"
                                                                :style="islemIndex === (_.size(sarj.islemler) - 1) &&
                                                                ...
                                                                <template v-else>
                                                                    <input v-model="islem.menevisSicakligi" type="text"
                                                                        class="form-control"
                                                            ...
                                                            <td style="border-right: 2px solid black; padding: 4px;max-width: 25px !important;"
                                                                ...
                                                                <template v-else>
                                                                    <input v-model="islem.cikisSuresi" type="number"
                                                                        class="form-control" placeholder="Süre" />
                                                                </template>
                                                            </td>
                                                            <td style="border-right: 2px solid black; padding: 4px;max-width: 25px !important;"
                                                                ...
                                                                <template v-else>
                                                                    <input v-model="islem.sonSertlik" type="text"
                                                                        class="form-control" placeholder="Son Sertlik" />
                                                                </template>
                                                            </td>
                                                        </tr>
                                                    </template>
        ...
        let mixinApp = {
            ...
            methods: {
                onyukleme() {
                    ...
                    this.sorguParametreleri.returnUrl = url.searchParams.get("returnUrl");
                    ...
                    axios.get(url, {
                        ...
                        .then(async response => {
                            ...
                            if (this.sorguParametreleri.formId) {
                                ...
                                try {
                                    setTimeout(() => {
                                        if (this.sorguParametreleri.sarj && this.sorguParametreleri
                                            .firinId) {
                                            const ref = this.$refs['firin' + this.sorguParametreleri
                                                .firinId + 'sarj' + this.sorguParametreleri.sarj];
                ...
                returnBack() {
                    console.log(this.sorguParametreleri.returnUrl);
                    if (this.sorguParametreleri.returnUrl) {
                        window.location.href = this.sorguParametreleri.returnUrl;
                    } else {
                    ...
                    return axios.get(url, {
                        ...
                        .then(response => {
                            ...
                            if (this.aktifForm.id && _.size(this.aktifForm.firmaGrupluIslemler.data)) {
                                this.aktifForm.secilenIslemler = _.unionBy(response.data.secilenIslemler, this
                                    .aktifForm.secilenIslemler, "id");

                                for (const [index, islem] of _.toPairs(this.aktifForm.secilenIslemler)) {
                                    const _islem = _.find(this.aktifForm.firmaGrupluIslemler.data, {
                                        id: islem.id
                                    });
                                    if (_islem) {
                                        _islem.firin = islem.firin && islem.firin.id ? _.find(this.firinlar, {
                                            id: islem.firin.id
                                        }) : null;
                ...
                async formaIslemEkleSil(islem) {

                    if (this.aktifForm.secilenIslemler.length > 0) {
                        console.log("girdi1");

                        if (islem.secildi == false && this.aktifForm.secilenIslemler[0].islemTuruId != islem
                            .islemTuruId) {

                            try {
                                const result = await this.uyariAc({
                                    baslik: 'Uyarı',
                                    mesaj: "Seçili işlem türü ile eklemek istediğiniz işlem türü aynı değildir. Yine de eklemek istiyor musunuz?",
                                    tur: "warning",
                                    ozellikler: {
                                        showDenyButton: true,
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    islem.secildi = false;
                                    console.log("girdi3");
                                    return; // Stop the execution here if not confirmed
                                }
                            } catch (error) {
                                console.error(error);
                                return;
                    ...
                    const islemIndex = _.findIndex(this.aktifForm.secilenIslemler, {
                        id: islem.id
                    });
                    if (islemIndex > -1) {
                        ...
                        if (this.aktifForm.id && _.find(this.aktifForm.baslangictakiIslemler, {
                                id: islem.id
                            })) {
                        ...
                        if (this.aktifForm.id && _.includes(this.aktifForm.silinecekIslemler, islem.id)) {
                            this.aktifForm.silinecekIslemler = _.without(this.aktifForm.silinecekIslemler, islem
                                .id);
                        }
                    }
                ...
                formaEkle(islem, p = {}) {
                    ...
                    const secilenIndex = _.findIndex(this.aktifForm.secilenIslemler, {
                        id: islem.id
                    });
                    if (secilenIndex === -1) {
                        this.aktifForm.secilenIslemler.push(islem);
                ...
                formIslemleriGetir(formId, formIndex, acikTut = false) {
                    if (this.formlar.data[formIndex].islemlerYukleniyor || (!acikTut && this.formlar.data[formIndex]
                            .islemlerAcik)) {
                ...
                islemBolIslemEkle(islem = null) {
                    const _islem = {
                        ...(islem || this.aktifBolunecekIslem.islem)
                    };
                ...
                bolunmusIslemNetDegisti(islem) {
                    const aktifDegisen = _.find(this.aktifBolunecekIslem.bolunmusIslemler, {
                        aktifDegisen: true
                    });
                    ...
                    if (net === 0) {
                        this.aktifBolunecekIslem.hatalar.sayiNegatif =
                            "Bir işlemin toplam net ağırlığı sıfır (0) olamaz.";
                    } else if (net < 0) {
                    ...
                    if (sifirdanKucukKayitVar) {
                        this.aktifBolunecekIslem.hatalar.sayiNegatifVeyaSifir =
                            "Bir işlemin toplam net ağırlığı sıfır (0) veya sıfırdan küçük olamaz.";
                    } else {
                        ...
                        .then(async response => {
                            ...
                            if (this.aktifBolunecekIslem.kaydettiktenSonraSec) {
                                _.forEach(this.aktifBolunecekIslem.bolunmusIslemler, (islem, index) => {
                                    if (index === 0) {
                                        const secilenIslemIndex = _.findIndex(this.aktifForm
                                            .secilenIslemler, {
                                                id: islem.id
                                            });
                            ...
                            await this.firmaGrupluIslemleriGetir(
                                undefined,
                                `{{ route('firmaGrupluIslemleriGetir') }}?page=` + this.aktifForm
                                .firmaGrupluIslemler.current_page
                            );
                ...
                truncateText(text, maxLength) {
                    // Metni 50 karaktere sınırlayalım
                    let truncatedText = text.slice(0, maxLength);

                    // Metni 3 heceden fazla olmamasını sağlayalım
