...
@section('content')
                    ...
                    <template v-if="aktifSayfa.kod === 'ANASAYFA'">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-auto ps-0">
                                        ...
                                        <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                            ...
                                            <i class="fa fa-filter" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="Filtreleme Aç"></i>
                                        </button>
                                    </div>

                                    <div class="col-auto">
                                        @can('siparis_kaydetme')
                                            <button @click="siparisEklemeAc" class="btn btn-primary btn-sm"><i
                                                    class="fas fa-plus" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Sipariş Ekle"></i> SİPARİŞ EKLE</button>
                                        @endcan
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="modal fade" id="filtrelemeModal" tabindex="-1"
                                            ...
                                            <div class="modal-body">
                                                <div class="row gap-3">
                                                    <div class="col-12 m-0">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input v-model.number="filtrelemeObjesi.termin"
                                                                    id="terminFiltre" type="number" class="form-control"
                                                                    aria-label="Termin günü" placeholder="Termin günü" />
                                                    ...
                                                    <div class="col m-0">
                                                        <div class="form-group">
                                                            ...
                                                            <v-select v-model="filtrelemeObjesi.firma"
                                                                :options="firmalar" label="firmaAdi" multiple
                                                                id="firmaFiltre"></v-select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 m-0">
                                                        <div class="form-group">
                                                            <div
                                                                class="row d-flex align-items-center justify-space-between">
                                                                <div class="col">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input v-model="filtrelemeObjesi.baslangicTarihi"
                                                                    type="date" class="form-control"
                                                                    placeholder="Başlangıç"
                                                                    data-date-container='#datepicker2'
                                                                    data-provide="datepicker" data-date-autoclose="true"
                                                                    id="tarih" aria-label="Başlangıç" />
                                                                <span class="input-group-text">Bitiş</span>
                                                                <input v-model="filtrelemeObjesi.bitisTarihi"
                                                                    type="date" class="form-control"
                                                                    placeholder="Bitiş" data-date-container='#datepicker2'
                                                                    data-provide="datepicker" data-date-autoclose="true"
                                                                    id="tarih" aria-label="Bitiş" />
                                                            </div>
                                                    ...
                                                    <div class="col m-0">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <span class="input-group-text">Başlangıç</span>
                                                                <input v-model="filtrelemeObjesi.faturaBaslangicTarihi"
                                                                    type="date" class="form-control"
                                                                    placeholder="Başlangıç"
                                                                    data-date-container='#datepicker2'
                                                                    data-provide="datepicker" data-date-autoclose="true"
                                                                    id="faturaTarih" aria-label="Başlangıç" />
                                                                <span class="input-group-text">Bitiş</span>
                                                                <input v-model="filtrelemeObjesi.faturaBitisTarihi"
                                                                    type="date" class="form-control"
                                                                    placeholder="Bitiş" data-date-container='#datepicker2'
                                                                    data-provide="datepicker" data-date-autoclose="true"
                                                                    id="faturaTarih" aria-label="Bitiş" />
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <select class="form-control select2"
                                                                        v-model="filtrelemeObjesi.siparisDurumu">
                                                        ...
                                                        <div class="col-auto m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <select class="form-control select2"
                                                                        v-model="filtrelemeObjesi.faturaDurumu">
                                                        ...
                                                        <div class="row m-0">
                                                            <div class="form-group">
                                                                <div class="form-check form-switch">
                                                                    <input type="checkbox" id="tutar"
                                                                        class="form-check-input"
                                                                        v-model="filtrelemeObjesi.tutar">
                                                                    <label for="tutar" class="form-check-label">
                                                                        <span class="text-primary">Toplam Tutar "0₺"
                                                                            Olanlar</span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-success"
                                                        data-bs-dismiss="modal" @click="excelCikti()">
                                                        <i class="fas fa-file-excel" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="Excell İndir"></i>
                                                        EXCEL
                                                    </button>
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">VAZGEÇ</button>
                                                    <button type="button" class="btn btn-primary"
                                                        data-bs-dismiss="modal" @click="filtrele()">ARA</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th data-priority="3" class="text-center">İşlem Sayısı
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            <template v-for="(siparis, index) in siparisler.data">
                                                                <tr :key="index + 'siparis'" @click="hizliDetayAc(index)"
                                                                    style="cursor: pointer"
                                                                    :class="!siparis.faturaKesildi && siparis.bitisTarihi ?
                                                                        'table-warning' : ''">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12">
                                                                                <span class="badge badge-pill"
                                                                                    style="color: black"
                                                                                    :class="`bg-${ siparis.gecenSureRenk }`">@{{ siparis.gecenSure }}
                                                                                    Gün</span>
                                                                                <div class="d-inline-flex"
                                                                                    v-if="siparis.islemYukleniyor">
                                                                                    <div class="spinner-grow text-primary m-1 spinner-grow-sm"
                                                                                        role="status">
                                                                                        <span
                                                                                            class="sr-only">Yükleniyor...</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <span
                                                                                    class="badge badge-pill bg-primary">@{{ siparis.siparisNo }}</span>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td class="uzun-uzunluk text-center">
                                                                        <div class="btn-group row d-inline-flex g-1">
                                                                            <div class="col">
                                                                                <button
                                                                                    @click.stop="siparisDetayAc(siparis)"
                                                                                    class="btn btn-primary btn-sm"><i
                                                                                        class="fas fa-eye"
                                                                                        data-bs-toggle="tooltip"
                                                                                        data-bs-placement="top"
                                                                                        title="Sipariş Detay"></i></button>
                                                                            </div>

                                                                            @can('siparis_duzenleme')
                                                                                <div class="col">
                                                                                    <button
                                                                                        @click.stop="siparisDuzenle(siparis)"
                                                                                        class="btn btn-warning btn-sm"><i
                                                                                            class="fas fa-edit"
                                                                                            data-bs-toggle="tooltip"
                                                                                            data-bs-placement="top"
                                                                                            title="Sipariş Düzenle"></i></button>
                                                                                </div>
                                                                            @endcan

                                                                            @can('siparis_silme')
                                                                                <div class="col">
                                                                                    <button @click.stop="siparisSil(siparis)"
                                                                                        class="btn btn-danger btn-sm"><i
                                                                                            class="fas fa-trash"
                                                                                            data-bs-toggle="tooltip"
                                                                                            data-bs-placement="top"
                                                                                            title="Sipariş Sil"></i></button>
                                                                                </div>
                                                                            @endcan
                                                                            <div class="col-12">
                                                                                <span
                                                                                    class="badge badge-pill bg-success">Son
                                                                                    Düzenleyen:
                                                                                    @{{ siparis.duzenleyen }}</span>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr v-if="_.size(siparis.islemler) && siparis.islemlerAcik"
                                                                    class="py-0" :key="index + 'formIslemleri'">
                                                                        ...
                                                                        <div class="table-responsive"
                                                                            ...
                                                                            <table class="table table-bordered nowrap"
                                                                                ...
                                                                                <thead>
                                                                                    ...
                                                                                    <th>Malzeme</th>
                                                                                    <th>Adet</th>
                                                                                    <th class="text-center">Miktar (KG)
                                                                                    </th>
                                                                                    <th>Dara (KG)</th>
                                                                                ...
                                                                                <tbody id="islem-satir-ekle">
                                                                                    <tr
                                                                                        v-for="(islem, iIndex) in siparis.bolunmusToplamliIslemler">
                                                                                        <td class="kisa-uzunluk">
                                                                                            <div class="col-12">
                                                                                                @{{ iIndex + 1 }}
                                                                                            </div>
                                                                                            <div class="col-12"
                                                                                                v-if="islem.islemTermini">
                                                                                                <span
                                                                                                    class="badge badge-pill"
                                                                                                    style="color: black"
                                                                                                    :class="`bg-${ siparis.gecenSureRenk }`">@{{ islem.islemTermini }}
                                                                                                    Gün</span>

                                                                                            </div>
                                                                                            <div class="col-12">
                                                                                                <span
                                                                                                    class="badge badge-pill bg-warning"><a
                                                                                                        :href="'/isil-islemler?formId=' +
                                                                                                        (islem.formId ||
                                                                                                            '')"
                                                                                                        style="color:white">Form
                                                                                                        ID:
                                                                                                        @{{ islem.formId || "-" }}</a></span>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td class="text-center">
                                                                                            <img :src="islem.resimYolu ? islem
                                                                                                .resimYolu :
                                                                                                varsayilanResimYolu"
                                                                                                class="kg-resim-sec"
                                                                                        ...
                                                                                        <td class="orta-uzunluk">
                                                                                            @{{ islem.malzeme ? islem.malzeme.ad : "-" }}</td>
                                                                                        <td>@{{ islem.adet ? islem.adet : "0" }}</td>
                                                                                        <td>@{{ islem.miktarYazi ? islem.miktarYazi : "0" }}</td>
                                                                                        <td class="orta-uzunluk"
                                                                                            :style="islem.daraSonraGirilecek ?
                                                                                                'background-color: #EB1D3666; color: white !important' :
                                                                                                ''">
                                                                                            <div class="col-12">
                                                                                                @{{ islem.daraYazi ? islem.daraYazi : "0" }}
                                                                                            </div>
                                                                                            <div class="col-12"
                                                                                                v-if="islem.daraSonraGirilecek">
                                                                                        ...
                                                                                        <td
                                                                                            ...
                                                                                            <b>
                                                                                                <h5>@{{ islem.netYazi ? islem.netYazi : "0" }}
                                                                                                </h5>
                                                                                            </b>
                                                                                        </td>
                                                                                        @can('siparis_ucreti_goruntuleme')
                                                    ...
                                                    <div class="row d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="col">
                                                            <ul
                                                                ...
                                                                <li v-for="sayfa in sayfalamaAyarla(siparisler.last_page, siparisler.current_page)"
                                                                    class="page-item"
                            ...
                            <div class="col-12 col-md-4 text-end">
                                @can('siparis_raporu_olusturma')
                                    <button @click="raporOlusturAc" class="btn btn-outline-primary"
                                        v-if="aktifSiparis.siparisId">
                                        <i class="fas fa-chart-line" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Rapor Oluştur"></i>
                                    </button>

                                    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false"
                                        id="raporlamaModal" tabindex="-1" aria-labelledby="raporlamaModal"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable modal-fullscreen-lg-down modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <button type="button" class="btn-close" @click="raporOlusturKapat"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row gap-3">
                                                        <div class="col-12 m-0">
                                                            <ul class="list-group text-start">
                                                                <li v-for="(islem, index) in siparisRaporlama.islemler"
                                                                    :class="{
                                                                        'list-group-item-primary': siparisRaporlama
                                                                            .islem && siparisRaporlama.islem.id == islem
                                                                            .id,
                                                                        'list-group-item-danger': (!siparisRaporlama
                                                                                .islem || siparisRaporlama.islem.id !=
                                                                                islem.id) && islem.islemDurumu
                                                                            .kod !== 'TAMAMLANDI',
                                                                    }"
                                                                    :aria-current="siparisRaporlama.islem && siparisRaporlama.islem
                                                                        .id == islem.id"
                                                                    :key="index"
                                                                    class="list-group-item list-group-item-action"
                                                                    style="cursor: pointer" @click="raporIslemSec(islem)">
                                                                    <div class="d-flex">
                                                                        <div class="col-2">
                                                                            <img :src="islem.resimYolu ? islem.resimYolu :
                                                                                varsayilanResimYolu"
                                                                                class="kg-resim-sec"
                                                                                @click.stop="resimOnizlemeAc(islem.resimYolu)" />
                                                                        </div>
                                                            ...
                                                            <template v-if="siparisRaporlama.islem">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-3 m-0 mb-2 text-start">
                                                                        <label class="form-label" for="gelisTarihi">Geliş
                                                                            Tarihi</label>
                                                                        <input
                                                                        ref="gelisTarihiInput"
                                                                    ...
                                                                    <div class="col-3 m-0 mb-2 text-start">
                                                                        ...
                                                                        <input v-model="siparisRaporlama.islem.kalite"
                                                                            class="form-control"
                                                                    ...
                                                                    <div class="col-3 m-0 mb-2 text-start">
                                                                        ...
                                                                        <input v-model="siparisRaporlama.islem.sonSertlik"
                                                                            class="form-control" placeholder="Örn: 65, 72, 70"
                                                                            @input="gecikmeliFonksiyon.siparisRaporlama('OLCUM')" />
                                                                        <small class="text-muted">
                                                                            Virgülle ayrılmış şekilde yazınız... (Örn: 65, 72,
                                                                            70)
                                                                        </small>
                                                                    </div>
    ...
    omission: "..."
                                                                    ...
                                                                    <div class="col-6 m-0 text-start">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            class="form-control" placeholder="Ölçüm No"
                                                                    ...
                                                                    <div class="col-6 m-0 text-start">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            class="form-control" placeholder="Sertlik"
                                                                            @input="gecikmeliFonksiyon.siparisRaporlama('YAXIS')" />

                                                                    </div>
                                                                    <div class="col-12 m-0 mb-2 text-start">
                                                                        <label class="form-label">Not</label>
                                                                        <textarea v-model="siparisRaporlama.islem.not" class="form-control"
                                                                            @input="gecikmeliFonksiyon.siparisRaporlama('NOT')"></textarea>
                                                                    </div>
                                                            ...
                                                            <div class="overflow-auto">
                                                                <div v-show="siparisRaporlama.islem"
                                                                    v-html="siparisRaporlama.html"
                                                                    :key="siparisRaporlama.islem ? siparisRaporlama.islem.id :
                                                                        'yok'">
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn btn-warning" data-toggle="tooltip"
                                                        data-placement="top"
                                                        title="Yukarıdaki alanlara girilen değerler rapora yansımadıysa bu butona basarak verileri senkronize edebilirsiniz."
                                                        @click="raporAlanlariDoldur">SENKRONİZE ET</button>
                                                    <button type="button" class="btn btn-danger"
                                                        @click="raporOlusturKapat">VAZGEÇ</button>
                                                    <button type="button" class="btn btn-primary" @click="raporOlustur"
                                                        :disabled="!siparisRaporlama.islem || !siparisRaporlama.islem.id">RAPOR
                                                        OLUŞTUR</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @can('siparis_duzenleme')
                                    <button @click="moduDegistir" class="btn btn-outline-info">
                                        <i class="fas fa-eye" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Önizleme Moduna Geç" v-if="!aktifSiparis.onizlemeModu"></i>
                                        <i class="fas fa-eye-slash" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Önizleme Modundan Çık" v-else></i>
                                    </button>
                                @endcan
                                ...
                                @canany(['siparis_duzenleme', 'siparis_kaydetme'])
                                    <button @click="siparisKaydet" class="btn btn-success"
                                        :disabled="_.size(aktifSiparis.islemler) === 0">
                                        <i class="fas fa-save" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Siparişi Kaydet"></i> KAYDET
                                    </button>
                                @endcan
                            </div>
                        </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-12 col-sm-6 col-md-4 mb-2">
                                    <div class="form-group">
                                        ...
                                        <template v-else>
                                            <label for="tarih">Tarih *</label>
                                            <input v-model="aktifSiparis.tarih" type="date" class="form-control"
                                                placeholder="gg.aa.yyyy" data-date-container='#datepicker2'
                                                data-provide="datepicker" data-date-autoclose="true" id="tarih" />
                                        </template>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 mb-2">
                                    ...
                                    <template v-else>
                                        ...
                                        <input v-model="aktifSiparis.siparisNo" v-mask="'DRK#######'"
                                            class="form-control"
                                            placeholder="Sipariş numarası giriniz... (Örn: DRK0000001)" type="text" />
                                    </template>
                                </div>
                                {{-- <div class="col-12 col-sm-6 col-md-4 mb-2">
                                <template v-if="aktifSiparis.onizlemeModu">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 mb-2">
                                    ...
                                    <template v-else>
                                        ...
                                        <input v-model="aktifSiparis.irsaliyeNo" v-mask="'IR#######'"
                                            class="form-control" placeholder="İrsaliye numarası giriniz... (IR0000001)"
                                            type="text" />
                                    </template>
                                </div>
                                @can('siparis_ucreti_goruntuleme')
                                    <div class="col-4 mb-2">
                                        ...
                                        <template v-else>
                                            ...
                                            <input v-model.lazy="aktifSiparis.tutarTLYazi" v-money="maskeler.tl"
                                                class="form-control" placeholder="Toplam tutarını giriniz..." disabled />
                                        </template>
                                    </div>
                                    <div class="col-4 mb-2">
                                        <template v-if="aktifSiparis.onizlemeModu">
                                        ...
                                        <template v-else>
                                            ...
                                            <input v-model.lazy="aktifSiparis.tutarUSDYazi" v-money="maskeler.usd"
                                                class="form-control" placeholder="Toplam tutarını giriniz..." disabled />
                                        </template>
                                    </div>
                                    <div class="col-4 mb-2">
                                        ...
                                        <template v-else>
                                            ...
                                            <input v-model.lazy="aktifSiparis.tutarEUROYazi" v-money="maskeler.euro"
                                                class="form-control" placeholder="Toplam tutarını giriniz..." disabled />
                                        </template>
                                    </div>
                                @endcan
                                <div class="col-6 col-sm-6 col-md-4 mb-2">
                                    <template v-if="aktifSiparis.onizlemeModu">
                                        <div class="form-group">
                                            ...
                                            <h5 id="terminSuresi">
                                                ...
                                                <span class="badge badge-pill"
                                                    :class="`bg-${ aktifSiparis.gecenSureRenk }`">@{{ aktifSiparis.gecenSure }}
                                                    Gün</span>
                                            </h5>
                                        </div>
                                    </template>
                                    <template v-else>
                                        ...
                                        <input v-model="aktifSiparis.terminSuresi" class="form-control"
                                            placeholder="Termin süresi giriniz..." type="number" />
                                    </template>
                                </div>
                                <div class="mb-3 col-12 col-sm-6 col-md-4">
                                    ...
                                    <template v-else>
                                        ...
                                        <select class="form-control select2" v-model="aktifSiparis.siparisDurumu">
                                            <optgroup label="Sipariş Durumu">
                                                <option v-for="(durum, index) in siparisDurumlari" :value="durum"
                                                    :key="index">
                                                    @{{ durum.ad }}
                                                </option>
                                            </optgroup>
                                    ...
                                    <template v-else>
                                        <div class="row d-flex align-items-end">
                                            <div class="col">
                                                ...
                                                <v-select v-model="aktifSiparis.firma" :options="firmalar"
                                                    label="firmaAdi">
                                            ...
                                            @can('firma_kaydetme')
                                                <div class="col-auto p-0">
                                                    <button class="btn btn-primary" @click="firmaEkleAc()">
                                    ...
                                    <div class="mb-3 col-12 col-sm-6 col-md-4 align-self-center">
                                        ...
                                        <template v-else>
                                            <div class="row d-flex align-items-end">
                                                <div class="form-group">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="faturaKesildi"
                                                            v-model="aktifSiparis.faturaKesildi" />
                                                        <label class="form-check-label" for="faturaKesildi">
                                                            <span v-if="aktifSiparis.faturaKesildi"
                                                                class="text-success">Fatura kesildi</span>
                                ...
                                <div class="col-12 col-sm-6 col-md-4" v-if="aktifSiparis.siparisId">
                                    <div class="form-group">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="islemDuzenle"
                                                v-model="aktifSiparis.islemDuzenle" @click="siparisDurumDegisti()" />
                                ...
                                <div class="form-group col-12 mb-2">
                                    ...
                                    <template v-else>
                                        <label for="aciklama">Açıklama</label>
                                        <textarea v-model="aktifSiparis.aciklama" class="form-control" id="aciklama" rows="3"></textarea>
                                    </template>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-bordered nowrap" id="urun-detay">
                                        <thead>
                                            ...
                                            @can('siparis_ucreti_goruntuleme')
                                                ...
                                                <th v-if="('islemDuzenle' in aktifSiparis) && aktifSiparis.islemDuzenle">Para
                                                    Birimi</th>
                                            @endcan
                                            <th>Kalite</th>
                                            <th>Yapılacak İşlem</th>
                                            <th>İstenilen Sertlik</th>
                                            <th>İşlem Durumu</th>
                                            <th v-if="('islemDuzenle' in aktifSiparis) && aktifSiparis.islemDuzenle">
                                                İşlemler</th>
                                        </thead>
                                        <tbody id="islem-satir-ekle">
                                            <template
                                                v-if="!('islemDuzenle' in aktifSiparis) || !aktifSiparis.islemDuzenle ">
                                                <tr v-for="(islem, index) in aktifSiparis.bolunmusToplamliIslemler">
                                                    <td>
                                                        <div class="row d-flex">
                                                            ...
                                                            <div class="col-12">
                                                                <span class="badge badge-pill bg-warning"><a
                                                                        :href="'/isil-islemler?formId=' + (islem.formId ||
                                                                        '') + '&returnUrl=/siparis-formu?siparisId=' + (
                                                                            aktifSiparis.siparisId || '')"
                                                                        style="color:white">Form ID:
                                                                        @{{ islem.formId || "-" }}</a></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="kisa-uzunluk text-center">
                                                        <b>
                                                            <h5>@{{ islem.netYazi ? islem.netYazi : "0" }}</h5>
                                                        </b>
                                                    </td>
                                                    @can('siparis_ucreti_goruntuleme')
                                            ...
                                            <template v-else>
                                                <tr v-for="(islem, index) in aktifSiparis.islemler" :key="index"
                                                    ...
                                                    <td>
                                                        <div class="row d-flex">
                                                            ...
                                                            <div class="col-12" v-if="islem.id">
                                                                <span class="badge badge-pill bg-primary">ID:
                                                                    @{{ islem.id }}</span>
                                                            </div>
                                                            <div class="col-12">
                                                                <span class="badge badge-pill bg-warning"><a
                                                    ...
                                                    <td class="text-center">
                                                        <img v-if="islem.resim || islem.resimYolu"
                                                            :src="islem.resim ? islem.resim : islem.resimYolu"
                                                            class="kg-resim-sec" @click="resimSecimAc(index)" />
                                                        <button v-else @click="resimSecimAc(index)"
                                                    ...
                                                    <td class="en-uzun-uzunluk">
                                                        <div class="row d-flex">
                                                            <div class="col">
                                                                <v-select v-model="islem.malzeme" :options="malzemeler"
                                                                    label="ad">
                                                                    <template #selected-option="option">
                                                                        <div class="row">
                                                                            <div class="col-12">
    ...
    omission: "..."
                                                            ...
                                                            @can('malzeme_kaydetme')
                                                                <div class="col-auto ps-0"
                                                                    v-if="!aktifSiparis.onizlemeModu && !islem.malzeme">
                                                            ...
                                                            @can('malzeme_duzenleme')
                                                                <div class="col-auto ps-0"
                                                                    v-else-if="!aktifSiparis.onizlemeModu && islem.malzeme">
                                                    ...
                                                    <td class="orta-uzunluk text-center">
                                                        <div class="row d-flex">
                                                            <div class="col-12">
                                                                <input class="form-control" v-money="maskeler.kg"
                                                                    placeholder="Miktar (KG)"
                                                                    v-model="islem.miktarYazi" />
                                                            </div>
                                                            <div class="col-12" v-if="islem.bolunmusId">
                                                                <span class="badge badge-pill bg-primary">Bölünmüş ID:
                                                                    @{{ islem.bolunmusId }}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="orta-uzunluk text-center"
                                                        :style="islem.daraSonraGirilecek ?
                                                            'background-color: #EB1D3666; color: white !important' : ''">
                                                        <input class="form-control" placeholder="Dara (KG)"
                                                            v-model="islem.daraYazi" v-money="maskeler.kg"
                                                            :disabled="islem.daraSonraGirilecek" />
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="daraSonraGirilecek"
                                                    ...
                                                    @can('siparis_ucreti_goruntuleme')
                                                        <td class="orta-uzunluk pe-0">
                                                            <input v-model="islem.birimFiyatYazi"
                                                                v-money="maskeler[islem.paraBirimi.maske]"
                                                                class="form-control" placeholder="Birim Fiyat" />
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="" id="miktarFiyatCarp"
                                                                    v-model="islem.miktarFiyatCarp">
                                                        ...
                                                        <td class="orta-uzunluk ps-0 pe-2">
                                                            <v-select v-model="islem.paraBirimi" :options="paraBirimleri"
                                                                label="ad" class="mb-4"></v-select>
                                                        </td>
                                                    @endcan
                                                    <td class="kisa-uzunluk">
                                                        <input class="form-control" type="text" placeholder="Kalite"
                                                            v-model="islem.kalite">
                                                    </td>
                                                    <td class="en-uzun-uzunluk">
                                                        <div class="row d-flex">
                                                            <div class="col">
                                                                <v-select v-model="islem.yapilacakIslem"
                                                                    :options="islemTurleri" label="ad">
                                                                    <template #selected-option="option">
                                                                        <div class="row">
                                                                            <div class="col-12">
    ...
    omission: "..."
                                                    ...
                                                    <td class="orta-uzunluk">
                                                        <select class="form-select" aria-label="İşlem Durumu"
                                                            v-model="islem.islemDurumu">
                                                            <option v-for="(islemDurumu, index) in islemDurumlari"
                                                                :value="islemDurumu" :key="index">
                                                                @{{ islemDurumu.ad }}
                                                            </option>
                                                        </select>
                                                    </td>
                                                    <td class="kisa-uzunluk" v-if="!aktifSiparis.onizlemeModu">
                                                        <button class="btn btn-danger"
                                                            @click="islemSil(index)">Sil</button>
                                                    </td>
                                                </tr>
                                            </template>
                                        </tbody>
        ...
        let mixinApp = {
                ...
                "aktifSiparis.islemler": {
                    handler: function(newValue, oldValue) {
                        ...
                        for (let i in this.aktifSiparis.islemler) {
                            ...
                            islem.birimFiyat = this.floatDonustur(islem.birimFiyatYazi, {
                                paraBirimi: islem.paraBirimi
                            });
                            islem.miktar = this.floatDonustur(islem.miktarYazi, {
                                kg: true
                            });
                            islem.dara = this.floatDonustur(islem.daraYazi, {
                                kg: true
                            });

                            islem.net = _.round(islem.miktar - islem.dara, 2);
                            islem.netYazi = this.yaziyaDonustur(islem.net, {
                                kg: true
                            });

                            const birimFiyat = _.round((islem.miktarFiyatCarp ? islem.net : 1) * islem.birimFiyat,
                                2);
            ...
            methods: {
                ...
                siparisleriGetir(url = "/siparisler", cikti = false) {
                    ...
                    var aramaInputEl = document.getElementById("aramaInput");
                    if (aramaInputEl) {
                        aramaInputEl.setAttribute("disabled", "disabled");
                    }
                    axios.get(url, {
                            params: {
                                cikti,
                        ...
                        .then(async response => {
                            ...
                            if (aramaInputEl) {
                                aramaInputEl.removeAttribute("disabled");
                            }
                        ...
                        if (result.isConfirmed) {
                            ...
                            axios.post("/siparisSil", {
                                ...
                                .catch(error => {
                                    ...
                                    this.uyariAc({
                                        baslik: 'Hata',
                                        mesaj: error.response.data.mesaj + " - Hata Kodu: " + error
                                            .response.data.hataKodu,
                                        tur: "error"
                                    });
                                    console.log(error);
                                });
                ...
                malzemeSecildiginde(islemIndex, malzeme) {
                    this.aktifSiparis.islemler[islemIndex].birimFiyat =
                        this.aktifSiparis.islemler[islemIndex].malzeme && this.aktifSiparis.islemler[islemIndex].malzeme
                        .birimFiyat ?
                                    ...
                                    .then(response => {
                                        ...
                                        this.malzemeleriGetir().then(() => {
                                            if (!this.aktifSiparis.islemler[islemIndex].malzeme) {
                                                this.aktifSiparis.islemler[islemIndex].malzeme =
                                                    response.data.malzeme;
                                                ...
                                                const malzemeIndex = _.findIndex(this.malzemeler, {
                                                    id: malzeme.id
                                                })
                                                if (malzemeIndex > -1) {
                                ...
                                axios.post("/islemTuruEkle", {
                                    ...
                                    .then(response => {
                                        ...
                                        this.islemTurleriGetir().then(() => {
                                            if (!this.aktifSiparis.islemler[islemIndex]
                                                .yapilacakIslem) {
                                                this.aktifSiparis.islemler[islemIndex].yapilacakIslem =
                                                    response.data.islemTuru;
                ...
                async hizliDetayAc(index) {
                    ...
                    this.siparisler.data[index].bolunmusToplamliIslemler = this.aktifSiparis
                ...
                daraSonraGirilecekAyarla(islem) {
                    if (islem.daraSonraGirilecek) {
                        islem.dara = 0;
                        islem.daraYazi = this.yaziyaDonustur(islem.dara, {
                            kg: true
                        });
                ...
                raporOlustur() {
                    ...
                    this.globalYazdir(this.siparisRaporlama.html, {
                        beforePrint: (printAreaEl) => {
                            this.$nextTick(() => {
                                const chart = new ApexCharts(printAreaEl.querySelector(
                                    ".siparis-raporlama-chart"), {
                    ...
                    switch (tur) {
                        case "OLCUM": {
                            if (this.siparisRaporlama.islem.sonSertlik != "") {
                                const olcumlerDizisi = _.map(_.split(this.siparisRaporlama.islem.sonSertlik, ","), _
                                    .trim);
                ...
                raporAlanlariDoldur() {
                    const rapor = {
                        ...
                        gelisTarihi: this.siparisRaporlama.islem.gelisTarihi ? new Date(this.siparisRaporlama.islem
                            .gelisTarihi).toLocaleDateString('tr-TR') : "---",
                        ...
                        yapilanIslem: this.siparisRaporlama.islem.yapilacakIslem ? this.siparisRaporlama.islem
                            .yapilacakIslem.ad : "---",
                        istenenSertlik: this.siparisRaporlama.islem.istenilenSertlik ? this.siparisRaporlama.islem
                            .istenilenSertlik : "---",
                        sonSertlik: this.siparisRaporlama.islem.sonSertlik ? this.siparisRaporlama.islem
                            .sonSertlik : "---",
                        not: this.siparisRaporlama.islem.not ? this.siparisRaporlama.islem.not : "---",
                        urunFotografi: this.siparisRaporlama.islem.resimYolu ? this.siparisRaporlama.islem
                            .resimYolu : "/no-image.jpg",
                    }
                    ...
                    this.siparisRaporlama.html = compiled({
                        rapor
                    });

                    this.$nextTick(() => {
                        this.siparisRaporlama.islem.onizlemeChart = new ApexCharts(document.querySelector(
                            ".siparis-raporlama-chart"), {
